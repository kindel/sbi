...
SBI-specific: feedback app (Situation, Behavior, Impact). The app is the static page under static/, served by main.go with everything embedded. Keep it dependency-free: no frameworks, no build step, nothing typed into the page leaves the page.
